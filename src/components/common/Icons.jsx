// SVG Icon components to replace emojis throughout the app

export function SunriseIcon({ className = "w-6 h-6" }) {
  return (
...
export function CrescentIcon({ className = "w-6 h-6" }) {
  return (
...
export function MosqueIcon({ className = "w-6 h-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function BeadsIcon({ className = "w-6 h-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M12 7v0M9 10l-2 2M15 10l2 2M7 16l-1 1M17 16l1 1" />
    </svg>
  )
}
...
export function FireIcon({ className = "w-6 h-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 23c-3.65 0-8-2.76-8-8.43C4 9.21 8 4.33 11.19 1.64c.32-.27.8-.2 1.03.15.96 1.47 2.85 5.13 2.26 8.26 1.06-.83 1.85-2.23 2.15-3.9.1-.54.6-.86 1.12-.71C20.12 6.2 22 9.13 22 13.14 22 19.57 17.5 23 12 23z" />
    </svg>
  )
}

export function HandsIcon({ className = "w-6 h-6" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
